...
//           <p className="text-gray-600 mt-1">Manage your company's assets</p>
//         </div>
//         <button
...
//           <div className="flex items-center justify-between">
//             <div>
//               <p className="text-gray-600 text-sm font-medium">Asset Types</p>
...
//           <p className="mt-4 text-gray-600 font-medium">Loading assets...</p>
//         </div>
//       ) : assets.length === 0 ? (

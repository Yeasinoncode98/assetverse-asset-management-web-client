...
export default function AssetList() {
  ...
  // CONTINUE TO PART 2 FOR JSX RETURN...

  // PART 2 - JSX RETURN (Continue from Part 1)
  ...
  return (
    <div className="w-full max-w-full px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8 mx-auto">
      ...
      {/* Stats Cards - Fully Centered Mobile */}
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6 max-w-full">
        {[
          ...
          <div
            key={idx}
            className={`bg-white p-4 rounded-lg shadow-md border-l-4 border-${stat.color}-500 flex flex-col items-center justify-center text-center`}
          >
            ...
            <p
              className={`text-2xl sm:text-3xl font-bold text-${stat.color}-600 mt-1`}
            >
              {stat.value}
            </p>
          </div>
      ...
      <div className="mb-6 max-w-full">
        <input
          ...
          value={searchTerm}
          onChange={(e) => setSearchTerm(e.target.value)}
          className="input input-bordered w-full text-center sm:text-left"
        />
      </div>

      {/* Showing X-Y of Z - Centered */}
      {!loading && assets.length > 0 && (
        <div className="flex flex-col sm:flex-row justify-between items-center mb-4 text-sm text-green-500 gap-2 text-center sm:text-left">
          <span>
            Showing{" "}
            <span className="font-semibold text-red-800">{startItem}</span> to{" "}
            <span className="font-semibold text-red-800">{endItem}</span> of{" "}
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-16 bg-white rounded-lg shadow px-4 text-center">
        ...
        <>
          ...
          {/* Mobile Cards - Fully Centered */}
          <div className="lg:hidden space-y-4 max-w-full">
            {assets.map((asset) => (
              <div
                key={asset._id}
                className="bg-white rounded-lg shadow-md overflow-hidden mx-auto max-w-md"
              >
                <div className="flex flex-col items-center gap-3 p-4 bg-gradient-to-r from-blue-50 to-indigo-50">
                  <div className="avatar">
                ...
                <div className="p-4 space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-2 pt-2 border-t">
                    ...
                    <button
                      onClick={() => handleDelete(asset._id, asset.productName)}
                      className="btn btn-sm bg-red-600 hover:bg-red-700 text-white gap-2"
                      disabled={deleteLoading === asset._id}
                    >
                      {deleteLoading === asset._id ? (
                        <span className="loading loading-spinner loading-xs"></span>
      ...
      {/* Tips Card - Centered on Mobile */}
      {assets.length > 0 && (
        <div className="mt-6 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-4 sm:p-6 max-w-full mx-auto">
          <div className="flex flex-col items-center sm:items-start sm:flex-row gap-3">
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="text-sm text-blue-800 space-y-2">
                <li>
                  • Keep track of available quantities for proper inventory
                </li>
                <li>• Track returnable assets when employees leave</li>

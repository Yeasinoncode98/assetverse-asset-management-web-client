...
export default function AddAsset() {
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden">
      <div className="w-full max-w-full px-3 sm:px-4 lg:px-6 py-4 sm:py-6 lg:py-8">
        <div className="mb-4 sm:mb-6 text-center">
          <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-black break-words">
            Add New Asset
          </h2>
        ...
        <div className="bg-white rounded-lg shadow-lg p-3 sm:p-6 lg:p-8 w-full max-w-2xl mx-auto">
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            ...
            <div className="form-control w-full">
              ...
              <label className="label px-0">
                <span className="label-text-alt text-xs sm:text-sm text-gray-500 break-words">
            ...
            <div className="form-control w-full">
              ...
              <div className="w-full">
                ...
                <input
                  ...
                  className="input input-bordered w-full text-sm sm:text-base focus:ring-2 focus:ring-blue-500 focus:border-transparent break-all"
                  disabled={uploadingImage}
                />
              </div>
              ...
              {/* Upload Progress */}
              {uploadingImage && (
                <div className="mt-3 sm:mt-4 flex items-center gap-2 p-3 bg-blue-50 rounded-lg w-full">
              ...
              {imagePreview && !uploadingImage && (
                <div className="mt-3 sm:mt-4 p-3 sm:p-4 bg-gray-50 rounded-lg w-full">
            ...
            {/* Submit Buttons */}
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-4 border-t border-gray-200 w-full">
              <button
                type="submit"
                className="btn btn-sm sm:btn-md bg-blue-600 hover:bg-blue-700 text-white flex-1 disabled:bg-gray-400 disabled:cursor-not-allowed w-full sm:w-auto"
              ...
              <button
                type="button"
                className="btn btn-sm sm:btn-md btn-outline flex-1 w-full sm:w-auto"
                onClick={() => navigate("/hr")}
                disabled={loading}
              >
        ...
        {/* Info Card */}
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-4 sm:p-6 mt-4 sm:mt-6 w-full max-w-2xl mx-auto">

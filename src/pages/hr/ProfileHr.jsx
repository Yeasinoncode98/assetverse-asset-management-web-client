...
//     try {
//       // ✅ UPDATED: Changed from /profile to /hr/profile
//       const response = await axios.put("/hr/profile", {
...
//                 </div>
//                 <div className="bg-white/20 backdrop-blur-md rounded-xl p-4 text-center border border-white/30 transition-all hover:bg-white/30 shadow-lg">
//                   <p className="text-4xl font-extrabold text-white drop-shadow-lg capitalize">
